 ...
 */
public class JCalendar1 extends JDialog implements PropertyChangeListener
{
    ...
    public JCalendar1(Frame parent, String title, boolean modal)
    {
    ...
    public JCalendar1(Frame parent, String title, boolean modal, int monthSpinner)
    {
        super(parent, title, modal);
        init(monthSpinner);
    }

    public JCalendar1(Dialog parent, String title, boolean modal)
    {
        super(parent, title, modal);
        init(0);
    }
